...
- Data para entrega do projeto: `13/02/2023 14:00`
...
1. Clone o repositório
   ...
   - Use o comando: `git clone git@github.com:tryber/sd-029-a-project-zoo-functions.git`

- Entre na pasta do repositório que você acabou de clonar:

  - `cd sd-029-a-project-zoo-functions`
...
6. Crie um novo `Pull Request` _(PR)_
   - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-029-a-project-zoo-functions/pulls)
   ...
   - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-029-a-project-zoo-functions/pulls) e confira que o seu _Pull Request_ está criado.
...
Neste projeto iremos focar na cobertura de _statements_ (ou seja, as instruções em JavaScript). Será avaliada a porcentagem de cobertura das instruções das funções, conforme destacado na figura abaixo:
...
2.  A função `getRelatedEmployees` será responsável por retornar as pessoas lideradas pela gerência: - Utilize a função `isManager` para verificar se a pessoa é gerente ou não e fazer as seguintes verificações:
